...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck sunrise-x-tree sunrise-x-tabs sunrise-x-modeline sunrise-x-mirror sunrise-x-loop sunrise-x-checkpoints sunrise-x-buttons s multiple-cursors multi-web-mode monokai-theme magit impatient-mode git-rebase-mode git-commit-mode expand-region color-theme auto-indent-mode auto-complete auto-auto-indent))))
(custom-set-faces
